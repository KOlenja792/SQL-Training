...
-- -----------------------------------------------------
-- Create table for: `northwind`.`customers` 
-- -----------------------------------------------------
    ...
    -- Notes 
    -- What is the purpose of the LONGTEXT type 
        -- The BLOB and TEXT Types
            -- BLOB
                -- BLOB - stands for binary large object that can hold a variable amount of data 
                -- Four types of BLOBs exist: TINYBLOB, BLOB, MEDIUBLOB, and LONGBLOB 
                -- These only differe in the maximum length the values can hold
            -- TEXT 
                -- Four TEXT types exist: TINYTEXT,TEXT, MEDIUMTEXT, and LONGTEXT  
                -- These correspond with the four BLOB types and have the same maximum lengths and storage requirements
    
    -- Storage requirements: https://dev.mysql.com/doc/refman/8.0/en/storage-requirements.html
...
-- -----------------------------------------------------
-- Create table for: `northwind`.`employees`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Create table for: `northwind`.`privileges`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Create table for: `northwind`.`employee_privileges`
-- -----------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`inventory_transaction_types`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`shippers`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`orders_tax_status`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`orders_status`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`orders`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`products`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`purchase_order_status`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for:`northwind`.`suppliers`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`purchase_orders`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`inventory_transactions`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`invoices`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`order_details_status`
-- -----------------------------------------------------------
    ...
    DEFAULT CHARACTER SET = utf8;
-- -----------------------------------------------------------
-- Create table for: `northwind`.`order_details`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`purchase_order_details`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for: `northwind`.`sales_reports`
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create table for:`northwind`.`strings`
-- -----------------------------------------------------------
